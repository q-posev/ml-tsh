...
demon2 = DemonNano(label='rundir/',input_arguments=input_arguments2)
...
if flag_es==3:
    ...
    atoms.set_calculator(demon2)
else:
    #atoms.set_calculator(calc)
    atoms.set_calculator(demon)
...
def printenergy(a=atoms):  # store a reference to atoms in the definition.
    ...
    if j_md == count_interpol:
        ...
        a.set_calculator(demon)
        force_down_t1 = a.get_forces()*Bohr/Hartree    
        a.set_calculator(demon2)
